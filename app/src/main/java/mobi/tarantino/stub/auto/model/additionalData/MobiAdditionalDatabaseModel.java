...
public class MobiAdditionalDatabaseModel extends AbstractModel {
    ...
    public void saveAnswerQuestionList(@NonNull List<AnswerQuestion> list) {
        try {
            AnswerQuestionDao answerQuestionDao =
                    (AnswerQuestionDao) getDaoImplementation(DaoImpl.ANSWER_QUESTION);
    ...
    public void update(@NonNull List<AnswerQuestion> list) {
        try {
            AnswerQuestionDao answerQuestionDao =
                    (AnswerQuestionDao) getDaoImplementation(DaoImpl.ANSWER_QUESTION);
            answerQuestionDao.saveList(list);
    ...
    public void saveEvent(@NonNull ArticleDBO articleDBO) {
    ...
    public void saveLaw(@NonNull ArticleDBO articleDBO) {
    ...
    public Action1<? super List<ArticleDBO>> updateArticles() {
        return new Action1<List<ArticleDBO>>() {
            @Override
            public void call(@NonNull List<ArticleDBO> articleDBOs) {
                ArticleDao articleDao = (ArticleDao) getDaoImplementation(DaoImpl.ARTICLE);
                try {
    ...
    @NonNull
    private BaseDaoImpl getDaoImplementation(@NonNull DaoImpl implementation) {
    ...
    public void markViewedArticle(@NonNull ArticleDBO articleDBO) {
        try {
    ...
    public void saveDriverAssistanceInfo(@NonNull List<DriverAssistanceInfoDBO> list) throws
            SQLException {
        DriverAssistanceDao dao = (DriverAssistanceDao) getDaoImplementation(DaoImpl
                .DRIVER_ASSISTANCE_INFO);
