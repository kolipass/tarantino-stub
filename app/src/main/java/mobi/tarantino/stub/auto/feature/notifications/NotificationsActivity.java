...
public class NotificationsActivity extends MvpViewStateActivity<NotificationsView,
    ...
    private void showArticle(@NonNull ArticleDBO article, @NonNull String type) {
    ...
    @NonNull
    private View getView(@NonNull ArticleDBO article, int icon) {
    ...
    @Override
    public void applyToolbarColorizer(@NonNull ToolbarColorizer toolbarColorizer) {
