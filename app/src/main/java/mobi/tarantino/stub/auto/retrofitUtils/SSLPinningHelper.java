...
public class SSLPinningHelper {
    public static X509TrustManager initSSLPinning(Context context) throws CertificateException,
...
// .intermediate_ca));
    ...
    @NonNull
    private static Certificate getCertificate(Context context, CertificateFactory cf, int id)
