...
public class PreferencesManager implements IPreferencesManager {
    ...
    public PreferencesManager(@NonNull Context context, @NonNull Logger logger) {
        this.logger = logger;
        ...
        } catch (@NonNull KeyStoreException | CertificateException | IOException |
    ...
    private void createNewKeys(@NonNull Context context, @NonNull String alias) throws
            KeyStoreException,
        ...
        if (!keyStore.containsAlias(alias)) {
            getKeyPair(context, alias);
        }
    }

    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR2)
    private KeyPair getKeyPair(@NonNull Context context, @NonNull String alias) throws
            NoSuchAlgorithmException,
    ...
    @NonNull
    private String decryptString(String alias, String cipherText, @NonNull KeyStore keyStore) throws
    ...
    private String encryptString(String alias, @NonNull String initialText, @NonNull KeyStore
            keyStore) throws
    ...
    public void setNewFinesCount(int count) {
        preferences.edit().putInt(NEW_FINES_COUNT, count).apply();
    }
    ...
    public void setRegisterGcmOnServer(boolean isRegistered) {
        preferences
                .edit()
                .putBoolean(GCM_IS_REGISTERED_ON_SERVER, isRegistered)
                .apply();
    }
