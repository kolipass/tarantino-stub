...
public class ValidatorHelper {
    ...
    public boolean driverLicenseNumber(String licenseNumber) {
    ...
    public boolean licensePlate(String licensePlate) {
    ...
    public boolean carCertificateNumber(String certificateNumber) {
