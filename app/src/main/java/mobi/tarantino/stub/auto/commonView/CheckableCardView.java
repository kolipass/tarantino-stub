...
public class CheckableCardView extends CardView implements Checkable {
    ...
    public CheckableCardView(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CheckableCardView(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
