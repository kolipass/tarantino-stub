...
public class FuelPrices implements ApiResponse, Parcelable, JsonDeserializer<FuelPrices> {
    ...
    public static final Creator<FuelPrices> CREATOR = new Creator<FuelPrices>() {
        @NonNull
        @Override
        public FuelPrices createFromParcel(@NonNull Parcel in) {
    ...
    protected FuelPrices(@NonNull Parcel in) {
    ...
    @NonNull
    @Override
    public FuelPrices deserialize(@NonNull JsonElement json, Type typeOfT,
    ...
    public List<FuelInfo> getFuelInfo(@NonNull FuelType fuelType) {
        switch (fuelType) {
            case AI_92:
                return ai92;
            case AI_95:
    ...
    public static class FuelInfo implements Parcelable {
        public static final Creator<FuelInfo> CREATOR = new Creator<FuelInfo>() {
            @NonNull
            @Override
            public FuelInfo createFromParcel(@NonNull Parcel in) {
