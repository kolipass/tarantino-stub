...
public class AbstractModel {
    ...
    protected <N extends ApiResponse> Observable<N> wrap(Observable<N> observable) {
        return observable
    ...
    protected <N extends List<? extends ApiResponse>> Observable<N> wrapList(Observable<N>
                                                                                     observable) {
        return observable
                .subscribeOn(schedulerProvider.network())
                .observeOn(schedulerProvider.ui());
    ...
    protected <N extends Object> Observable<N> wrapDefaultObservableObject(Observable<N>
                                                                                   observable) {
        return observable
                .subscribeOn(schedulerProvider.network())
                .observeOn(schedulerProvider.ui());
