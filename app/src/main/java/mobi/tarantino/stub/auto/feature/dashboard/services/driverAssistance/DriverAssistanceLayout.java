...
public class DriverAssistanceLayout extends CardView implements OnBeUserVieweble {
    ...
    public DriverAssistanceLayout(Context context) {
        super(context);
    }

    public DriverAssistanceLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DriverAssistanceLayout(Context context, AttributeSet attrs, int defStyleAttr) {
