...
public class ArticleDBO implements DBO, Parcelable {
    ...
    public static final Parcelable.Creator<ArticleDBO> CREATOR = new Parcelable
            .Creator<ArticleDBO>() {
        @Override
        public ArticleDBO createFromParcel(Parcel source) {
    ...
    protected ArticleDBO(Parcel in) {
        this.id = in.readInt();
    ...
    public static ArticleDBO createOrUpdate(ArticleDBO articleDBO, Article article) {
        if (articleDBO == null) {
