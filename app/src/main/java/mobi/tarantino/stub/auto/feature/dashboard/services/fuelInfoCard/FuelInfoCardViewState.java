...
public class FuelInfoCardViewState extends AbsParcelableLceViewState<FuelPrices, FuelInfoCardView> {
    ...
    public static final Creator<FuelInfoCardViewState> CREATOR = new
            Creator<FuelInfoCardViewState>() {
                @NonNull
                @Override
                public FuelInfoCardViewState createFromParcel(@NonNull Parcel in) {
    ...
    protected FuelInfoCardViewState(@NonNull Parcel in) {
        readFromParcel(in);
    }
    ...
    @Override
    public void apply(@NonNull FuelInfoCardView view, boolean retained) {
