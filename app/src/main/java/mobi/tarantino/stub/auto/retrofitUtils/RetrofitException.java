...
public class RetrofitException extends RuntimeException {
    ...
    RetrofitException(String message, String url, Response response, Kind kind, Throwable
    ...
    @Nullable
    public static RetrofitException httpError(String url, @NonNull Response response, Retrofit
            retrofit) {
     ...
     */
    @Nullable
    public <T> T getErrorBodyAs(@NonNull Class<T> type) throws IOException {
        if (response == null || response.errorBody() == null) {
            return null;
        }
        Converter<ResponseBody, T> converter = retrofit.responseBodyConverter(type, new
                Annotation[0]);
