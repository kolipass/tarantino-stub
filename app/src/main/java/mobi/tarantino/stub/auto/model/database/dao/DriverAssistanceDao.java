...
public class DriverAssistanceDao extends BaseDaoImpl<DriverAssistanceInfoDBO, Integer> {
    ...
    public DriverAssistanceDao(ConnectionSource connectionSource,
                               DatabaseTableConfig<DriverAssistanceInfoDBO> tableConfig) throws
            SQLException {
    ...
    public void saveOrUpdateList(final List<DriverAssistanceInfoDBO> list) throws SQLException {
