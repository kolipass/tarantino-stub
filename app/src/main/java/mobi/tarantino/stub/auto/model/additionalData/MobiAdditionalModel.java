...
public class MobiAdditionalModel extends AbstractModel {
    ...
    public Observable<List<DriverAssistanceInfo>> getDriverAssistanceInfo() {
        ...
        Observable<List<DriverAssistanceInfo>> dboObservable = Observable
                ...
                .map(new Func1<List<DriverAssistanceInfoDBO>, List<DriverAssistanceInfo>>() {
                    @Override
                    public List<DriverAssistanceInfo> call(@NonNull List<DriverAssistanceInfoDBO>
                                                                   list) {
        ...
        Observable<List<DriverAssistanceInfo>> listObservable = Observable
                ...
                .doOnNext(new Action1<List<DriverAssistanceInfo>>() {
                    @Override
                    public void call(@NonNull List<DriverAssistanceInfo> driverAssistanceInfos) {
    ...
    private Observable<String> getCity() {
        return locationModel
                ...
                .map(new Func1<Address, String>() {
                    @Override
                    public String call(@NonNull Address address) {
    ...
    private void addDefaultDriverAssistanceInfo(@NonNull List<DriverAssistanceInfo>
                                                        driverAssistanceInfos) {
        ...
        if (random.nextBoolean()) {
            return wrapList(api.getQuestions(0))
                    ...
                    .map(new Func1<List<AnswerQuestion>, List<AnswerQuestion>>() {
                        @NonNull
                        @Override
                        public List<AnswerQuestion> call(@NonNull List<AnswerQuestion> list) {
    ...
    @NonNull
    public Observable<Response<ResponseBody>> likeQuestion(@NonNull final Question question) {
    ...
    @NonNull
    public Observable<Response<ResponseBody>> dislikeQuestion(@NonNull final Question question) {
...
//                api.getArticles(0)
    ...
    class SortArticles implements Action1<List<Article>> {
        @Override
        public void call(@NonNull List<Article> articles) {
    ...
    private class MergeDboArticles implements Func2<List<Article>, Map<Integer, ArticleDBO>,
        ...
        @NonNull
        @Override
        public List<ArticleDBO> call(@NonNull List<Article> articles, @NonNull Map<Integer,
                ArticleDBO>
    ...
    private class FillTitle implements Action1<List<ArticleDBO>> {
        ...
        @Override
        public void call(@NonNull List<ArticleDBO> articles) {
