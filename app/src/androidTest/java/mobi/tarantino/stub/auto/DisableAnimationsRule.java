...
/**
 * https://product.reverb.com/2015/06/06/disabling-animations-in-espresso-for-android-testing/
 */
...
public class DisableAnimationsRule implements TestRule {
    ...
    public DisableAnimationsRule() {
        try {
            ...
            mSetAnimationScalesMethod = windowManagerClazz.getDeclaredMethod
                    ("setAnimationScales", float[].class);
    ...
    private void setAnimationScaleFactors(float scaleFactor) throws Exception {
        ...
        mSetAnimationScalesMethod.invoke(mWindowManagerObject, (Object) scaleFactors);
    }
}